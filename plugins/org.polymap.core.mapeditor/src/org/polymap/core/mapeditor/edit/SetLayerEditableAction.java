 ...
 * {@link ILayer}. It puts the given layer in "features editable" mode.
 * The actual operation is done by {@link SetLayerEditableOperation}.
 * 
 * @author <a href="http://www.polymap.de">Falko Braeutigam</a>
 * @version POLYMAP3 ($Revision$)
 * @since 3.0
 */
public class SetLayerEditableAction
        implements IViewActionDelegate {

    private static Log log = LogFactory.getLog( SetLayerEditableAction.class );
    ...
    public void run( IAction action ) {
        try {
            ...
            SetLayerEditableOperation op = new SetLayerEditableOperation( layer, action.isChecked() );
...
//        layer.getGeoResource().resolve( IService.class );
        ...
        if (layer != null 
                ...
                && (editor.findSupport( IEditFeatureSupport.class) == null || layer.isEditable())) {
