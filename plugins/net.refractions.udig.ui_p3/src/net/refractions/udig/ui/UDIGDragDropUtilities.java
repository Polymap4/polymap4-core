...
public class UDIGDragDropUtilities {
    ...
    private static Log log = LogFactory.getLog( UDIGDragDropUtilities.class );
...
//        log.info( "No DnD support in RAP." );
//        return null;
...
//        return null;
     ...
     * 
     */
    static private class EditorPlaceholder 
    implements IEditorPart, IDropTargetProvider {
