 ...
 */
public class PropertyMappedColorsChooser {
    ...
    private static final IMessages i18n = Messages.forPrefix( "PropertyMappedColorsChooser" );
    ...
    public PropertyMappedColorsChooser( String propertyName, Color defaultColor, Map<String,Color> initialColors,
    ...
    private static Log log = LogFactory.getLog( PropertyMappedColorsChooser.class );
