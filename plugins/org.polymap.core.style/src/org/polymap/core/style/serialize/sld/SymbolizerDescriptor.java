...
public abstract class SymbolizerDescriptor
    ...
    public static final FilterFactory       ff = SLDSerializer.ff;

    /** 
     * Some description to be placed in the resulting SLD to help human readers
    ...
    /** In SLD this is the possible scale in a {@link Rule}. */
    public Config<Pair<Integer,Integer>>    scale;

    /** In SLD this is the possible filter in a {@link Rule}. */
    public Config<Filter>                   filter;

    /** In SLD this denotes the {@link FeatureTypeStyle}. */
    @Immutable
