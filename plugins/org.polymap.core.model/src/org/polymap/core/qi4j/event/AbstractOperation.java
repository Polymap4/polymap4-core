 ...
 * </p>
 * The source has been moved to this polymap package as we need to change
 * some method modifiers to let the Qi flow.
 * 
 * @see org.eclipse.core.commands.operations.IUndoableOperation
 * 
 * @since 3.1
 */
abstract class AbstractOperation implements IUndoableOperation {
    ...
    /* falko:
     * provide identity for TransientComposite operations; the composite must
     * declare these methods; without operations are never removed from the
     * history since this depends on equals/hashCode
     */
    ...
    public boolean equals( Object obj ) {
        //System.out.println( "equals(): obj= " + obj.getClass().getName() );
        return (obj instanceof IUndoableOperation) ? id == obj.hashCode() : false;
    }
    ...
    public String toString() {
        ...
        IUndoContext[] _contexts = getContexts();
        for (int i = 0; i < _contexts.length; i++) {
            stringBuffer.append(_contexts[i].toString());
