    ...
    implements CompositeInstance, MixinsInstance
{
    ...
    public Object invoke( Object proxy, Method method, Object[] args )
        throws Throwable
    {
/*falko:        if (method.getName().equals( "equals" )) {
//            if (proxy == args[0]) {
...
//            else {
                if (args[0] == null) {
                    ...
                    String lhs = identity.identity();
                    String rhs = ((Identity)args[0]).identity().get();
                    System.out.println( "equals(): " + lhs + " - " + rhs );
...
//            }
    ...
    public boolean equals( Object o )
    {
        ...
        {
            // Falko: UI may hold removed instances; equals should work anyways
            return false;
        }
    }
