...
public class ACLPropertiesPage
    ...
    protected Control createContents( Composite composite ) {
        ...
        // start operation
        if (acl instanceof Entity) {
            module = Qi4jPlugin.Session.instance().resolveModule( acl );
            changes = module.newChangeSet();
...
//                checkFinish();
    ...
    public boolean performCancel() {
        log.debug( "..." );
        if (module != null && module.hasOperation()) {
    ...
    public boolean performOk() {
        ...
        try {
            OperationSupport.instance().execute( 
                    new ACLOperation( module ), false, false );
            return true;
        }
    ...
    static class ACLOperation
        ...
        public ACLOperation( QiModule module ) {
