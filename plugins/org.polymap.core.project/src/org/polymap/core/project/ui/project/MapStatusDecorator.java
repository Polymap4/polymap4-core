...
public class MapStatusDecorator
    ...
    private static final ImageDescriptor    empty = ProjectPlugin.instance().imageDescriptor( "icons/obj16/map_empty_obj.gif" );
    private static final ImageDescriptor    visible = ProjectPlugin.instance().imageDescriptor( "icons/obj16/map_obj.gif" );
    private static final ImageDescriptor    visibleOvr = ProjectPlugin.instance().imageDescriptor( "icons/ovr16/visible_ovr.png" );
