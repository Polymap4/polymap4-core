 ...
 * @since 3.0
 */
public class MapBasePropertiesPage 
        extends FieldEditorPreferencePage
        implements IWorkbenchPropertyPage {

    private static Log log = LogFactory.getLog( MapBasePropertiesPage.class );
