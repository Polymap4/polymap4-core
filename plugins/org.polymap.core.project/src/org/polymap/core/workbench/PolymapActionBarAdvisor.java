...
public class PolymapActionBarAdvisor
    ...
    protected void makeActions( final IWorkbenchWindow window ) {
        ...
        newAction.setImageDescriptor( CorePlugin.instance().imageDescriptor( "icons/etool16/add.gif" ) );
        register( newAction );
        ...
        new2Action.setImageDescriptor( CorePlugin.instance().imageDescriptor( "icons/etool16/add.gif" ) );
        register( new2Action );

        importAction = ActionFactory.IMPORT.create( window );
        importAction.setImageDescriptor( CorePlugin.instance().imageDescriptor( "icons/etool16/import3.gif" ) );
        ...
        preferencesAction.setImageDescriptor( CorePlugin.instance().imageDescriptor( "icons/etool16/show_prefs.gif" ) );
        ...
        restartAction.setImageDescriptor( CorePlugin.instance().imageDescriptor( "icons/etool16/exit.gif" ) );
        ...
        aboutAction.setImageDescriptor( CorePlugin.instance().imageDescriptor( "icons/etool16/info_tsk.gif" ) );
...
//        polymapWebSiteAction.setImageDescriptor( rapWebSiteActionImage );
        ...
        showViewAction.setImageDescriptor( CorePlugin.instance().imageDescriptor( "icons/etool16/show_view.gif" ) );
