...
public class FileEncodingGuesserTest {
    ...
    private void detect( File file, String expectedCharset ) throws IOException {
        ...
        System.out.println( "File: " + file.getName() + " - Encoding: " + cm.getName() + ":" + cm.getLanguage()
    ...
    public static void main( String[] args ) throws ParseException, UnsupportedEncodingException {
        ...
        // }
        // formats.asMap().forEach( (key, value) -> System.out.println(key + ": " +
        // value) );
        ...
        // "�" );
        // strings.forEach( str -> System.out.println( str + " matches? " +
        // asciiOnly.matcher( str ).matches() ));
