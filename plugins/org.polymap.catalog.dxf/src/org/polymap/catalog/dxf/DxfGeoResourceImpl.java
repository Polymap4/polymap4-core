...
/**
 * Connect to a DXF file.
 * 
 * @author David Zwiers, Refractions Research
 * @author <a href="http://www.polymap.de">Falko Braeutigam</a>
 * @since 3.1
 */
public class DxfGeoResourceImpl
        extends IGeoResource {

    DxfServiceImpl parent;
    ...
    /**
     * Construct <code>DxfGeoResourceImpl</code>.
     * 
     * @param parent
     * @param typename
     */
    public DxfGeoResourceImpl( DxfServiceImpl parent, String typename ) {
        this.service = parent;
        this.parent = parent;
     ...
     * <p>
     * 
     * @return DxfServiceImpl responsible for this DxfGeoResourceImpl
     */
    public DxfServiceImpl service() {
        return parent;
    }
    ...
    protected IGeoResourceInfo createInfo( IProgressMonitor monitor )
            throws IOException {
        return new DxfGeoResourceInfo( this );
    }
}