        ...
        public IStatus run( final IProgressMonitor monitor ) {
            ...
            try{
                while( !toDecorate.isEmpty() ) {
                    ...
                    System.out.println("ResolveTitleDecorator: " + element.getIdentifier()); //$NON-NLS-1$
        ...
        private void addUpdate( final IProgressMonitor monitor, final IResolve element ) {
            ...
            synchronized (updater.updates) {
                if (updater.updates.isEmpty()){
                    ...
                    //final Display display = RWTLifeCycle.getSessionDisplay(); //_p3: commented out:  Display.getDefault();
