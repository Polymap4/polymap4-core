...
public class ConnectionFactoryManager {
	...
	protected ConnectionFactoryManager() {
        IExtensionPoint point = Platform.getExtensionRegistry().getExtensionPoint(UDIGConnectionFactory.XPID);
        if (point == null) {
            throw new IllegalStateException( "No extension point: " + UDIGConnectionFactory.XPID );
        }
